      ...
      <main className="flex-grow p-6 md:p-12 lg:p-16">
        <div className="max-w-5xl mx-auto">
          ...
          <header className="mb-12 text-center md:text-left flex flex-col md:flex-row md:justify-between md:items-end gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-headline font-light text-[#D4AF37] mb-2">Welcome, {user.firstName}</h1>
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-[#D4AF37] font-display font-semibold">Premium Member</p>
            </div>
          </header>
              ...
              <form onSubmit={handleSave}>
                ...
                <section className="mb-12">
                  <div className="flex items-center gap-3 mb-6 pb-2 border-b border-[#222]">
                    <MdBadge className="text-[#D4AF37] text-xl" />
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#111111] border border-[#333333] rounded p-8 relative overflow-hidden group sticky top-28">
                ...
                <div className="flex items-center gap-3 mb-6 relative z-10">
                  <MdWorkspacePremium className="text-[#D4AF37] text-3xl" />
                  <h3 className="text-lg font-headline font-semibold text-[#D4AF37] tracking-wide">LaFleur Privilège</h3>
                </div>
                
                <p className="text-sm font-body leading-relaxed text-neutral-400 mb-8 relative z-10">
                  You are <span className="text-white font-semibold">1 order away</span> from unlocking a lifetime <span className="text-[#D4AF37]">10% discount</span> on all exclusive collections.
                </p>
                ...
                <div className="flex justify-between text-xs font-label text-neutral-500 relative z-10">
                  <span>Tier 1</span>
                  <span className="text-[#D4AF37]">Tier 2</span>
                </div>
              </div>
            </div>
